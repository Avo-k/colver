...
_DEFAULT_PLAYGEN_URL = "https://github.com/Avo-k/colver/releases/download/v0.7.0/playgen_final.bin"
...
def playgen_model_path(name: str = "playgen_final.bin") -> Path | None:
