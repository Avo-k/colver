// BoardRenderer: shared board rendering for Watch and Replay tabs

const SUIT_LABELS = ['\u2660', '\u2665', '\u2666', '\u2663'];

class BoardRenderer {
    constructor(opts) {
        this.prefix = opts.prefix; // 'watch' or 'replay'
    ...
    reset(initialState) {
        ...
        if (_animatingTrick === this.trickPrefix) _animatingTrick = null;
    }
    ...
    _bindKeyboard() {
        document.addEventListener('keydown', (e) => {
            const panel = document.getElementById(`${this.prefix}-panel`);
    ...
    _renderFinishedStats(state) {
        ...
        // Incomplete replay: game not actually terminal
