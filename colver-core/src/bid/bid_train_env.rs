...
/// La base est passée de 160 à 162, puis l'arrondi à la dizaine a sauté (2026-07-31), après
/// ce fit : une marque bouge de ≤5 points sur une partie en 2000, donc la calibration tient
/// (cf. `engine/scoring.rs`).
...
mod tests {
    ...
    fn test_compute_scores_belote_bonus() {
        ...
        // Score (exact, sans arrondi): 80 + 80 + 20 = 180. EW: 82.
